        ...
        <section className="lg:w-full lg:h-[80vh] lg:items-center lg:justify-center flex flex-col mt-10 lg:mt-0">
            <div className="flex lg:justify-between lg:flex-row flex-col-reverse w-full">
                ...
                <div className="lg:w-1/2 flex flex-col lg:place-content-center space-y-4 font-normal lg:text-start text-center mt-5 lg:mt-0">
                    <h1 className="text-3xl lg:text-[30px] leading-[120%] font-normal">Make Every Events <br /> Extraordinary with <span className="text-gradient md:font-medium font-bold"> Vastraa's <br /> Costumes and Events!</span>
                    </h1>
                    <div>
                    ...
                    <div className="flex space-x-4 justify-center lg:justify-start">
                        ...
                        <button className="font-bold md:font-semibold text-[#1B1B1E] border-black border-2 px-6 py-2 rounded-lg w-[156px]">Bulk Order?</button>
                    </div>
                </div>

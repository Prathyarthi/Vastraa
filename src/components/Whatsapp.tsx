...
const Whatsapp: React.FC = () => {
    ...
    const messages = {
        type: 'incoming',
        text: 'Hi there 👋\nWelcome to Vastraa!\nClick the button below to order online using Whatsapp'
    }
            ...
            <div className="chatbot">
                ...
                <ul className="chatbox">
                    <li className={`chat ${messages.type}`}>
                        ...
                        <p className='md:text-xl lg:font-semibold'>{messages.text}</p>
                    </li>
                </ul>
                <div className="chat-input">
                    <a rel="noreferrer" className='bg-[#25D366] font-normal text-white px-6 py-2 rounded-lg w-full lg:h-[48px] flex justify-center items-center md:text-xl text-lg' href="https://wa.me/919900485461" target='_blank'>
                        <button className="">Book Your Costume?</button>
                    </a>
                </div>
            </div>
        </div>

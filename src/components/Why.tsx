                ...
                <div className="flex space-x-4">
                    ...
                    <div className="flex flex-col">
                        <div className="space-y-4">
                            <h1 className="font-bold md:font-semibold md:text-4xl text-3xl text-primary">Team</h1>
                            <p className="text-base text-primary font-normal leading-[140%]">Expert Team with Dance and Art Backgrounds <br className="hidden lg:block" />
